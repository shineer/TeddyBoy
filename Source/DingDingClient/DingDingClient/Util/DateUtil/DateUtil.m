...
/**
 *  @brief 根据NSTimeInterval 返回 时间(kDU_YYYYMMddhhmmss)
 */
+ (NSString *)timeIntervalToRealString:(NSTimeInterval)msgTime
{
    NSString *strTimeStamp = [self getDateStringWithSecound:msgTime format:kDU_YYYYMMddhhmmss];
