...
static SearchUtil *defaultUtil = nil;
...
+ (instancetype)getInstance
{
    ...
    dispatch_once(&onceToken, ^{
        defaultUtil = [[SearchUtil alloc] init];
    });
...
#pragma clang diagnostic pop
                        ...
                        // 由于我们程序里面聊天得对象chatter都是使用的usrId,所以需要转成对应的用户名昵称
                        DDContactData* contact = [DDContactData contactByUid:tmpString];
                        tmpString = contact.nickName;
                    }
                }
