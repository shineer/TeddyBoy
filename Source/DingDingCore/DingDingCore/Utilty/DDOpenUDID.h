...
//
// Usage:
//    #include "DDOpenUDID.h"
//    NSString* openUDID = [DDOpenUDID value];
//

#define kDDOpenUDIDErrorNone          0
#define kDDOpenUDIDErrorOptedOut      1
#define kDDOpenUDIDErrorCompromised   2

@interface DDOpenUDID : NSObject
{
}
+ (NSString*) value;
